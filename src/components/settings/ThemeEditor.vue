...
import { themeEditorWindowControl } from "@/services/api";
...
function updatePreview() {
  ...
  tempTheme.value.data.themeProperties = {
    ...
    ...tempTheme.value.data.puredownCssProperties,
  };
...
function handleClose() {
  ...
  themeEditorWindowControl("close").catch((e) => console.error("[ThemeEditor] close failed:", e));
}
...
function applyThemePreset(cn: ThemeName) {
  ...
  const { puredownCssProperties, appCssProperties } = theme.data;

  tempTheme.value!.data.appCssProperties = appCssProperties;
  tempTheme.value!.data.puredownCssProperties = puredownCssProperties;
    ...
    <div class="editor-container">
      ...
      <div class="config-panel">
        ...
        <div class="panel-content">
          ...
          <div class="config-section">
            ...
            <div
              v-for="(_, attr) in tempTheme?.data.puredownCssProperties"
              :key="attr"
              class="form-section"
            >
              <div class="variables-list">
                <div class="variable-item">
                  ...
                  <div class="color-input-group">
                    <ColorPicker
                      v-model="tempTheme!.data.puredownCssProperties[attr]"
                      size="medium"
                      @change="updatePreview"
                    />
                    <input
      ...
      <div class="preview-panel">
        ...
        <div class="preview-content">
          <PureMarkEditor :tab="previewTab" :is-active="true" class="preview-editor" />
        </div>
      </div>
    </div>
  </div>
