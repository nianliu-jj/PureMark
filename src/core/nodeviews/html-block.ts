...
export class HtmlBlockView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "puremark-html-block";
    this.applyInlineHtmlClass(node);

    // 创建 header（固定显示 "HTML"）
    this.header = document.createElement("div");
    this.header.className = "puremark-html-block-header";
    const label = document.createElement("span");
    label.className = "puremark-html-block-label";
    ...
    this.preview.className = "puremark-html-block-preview";
    this.dom.appendChild(this.preview);

    // 创建编辑器容器
    this.editorContainer = document.createElement("div");
    this.editorContainer.className = "puremark-html-block-editor";
